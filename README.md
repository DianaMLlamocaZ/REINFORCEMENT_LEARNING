...
3. **POLICY-BASED METHODS: POLICY GRADIENT**
   - [PolicyGradient](./POLICY-GRADIENT): Aquí almaceno proyectos de aprendizaje por refuerzo basados en *policy-based methods*, además de algoritmos que emplean el cálculo de gradientes para entrenar la política directamente.
