...
- Gráfica del número de 'pasos' en cada episodio: Mientras 'menos negativo sea', significa que el agente necesitó menos pasos para llegar a la meta, ya que su objetivo es llegar a la meta con el menor número de pasos posibles.
  <div align="center">
